<template>
  <div class="auth">
    <div class="auth-container">
      <div class="heading">
        Register for play<label class="switch">CTF</label>
      </div>
        ...
        <div v-if="currentStep === 1">
          ...
          <div class="info" v-if="otpSent">
            ...
            <div class="timer-container">
              ...
              <button v-else @click="sendOTP" class="resend-button">
                Resend OTP
              </button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    validateUsername() {
      this.UsernameErr =
        this.username.length > 12 ? 'Username should be 12 characters max' : '';
    },
    validateEmail() {
    ...
    proceedToPassword() {
      if (this.uname && this.username && !this.UsernameErr) {
        this.currentStep = 3;
      } else {
        this.$vToastify.error(
          'Please fill all required fields correctly',
